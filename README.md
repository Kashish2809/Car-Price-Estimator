...
**User-Friendly Interface:** Clean, responsive web interface designed with modern CSS and Glassmorphism effects.
...
Key Features: Year, Selling_Price, Present_Price, Kms_Driven, Fuel_Type, Seller_Type, Transmission, Owner.
